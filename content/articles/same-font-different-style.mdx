export const metadata = {
  ...
  image: "/articles/same-font-different-style.avif",
...
![My personal website](/articles/portfolio-before.avif)
...
![Brittany Chiang's portfolio](/articles/brittany-site.avif)
