...
summary: "Learn how to transition display: none in CSS using modern features like transition-behavior: allow-discrete and @starting-style. This article explains why traditional transitions fail and shows how to animate elements smoothly as a progressive enhancement."
image: "/articles/transition-from-display-none-in-css.jpg"
tags:
  - "HTML"
  - "CSS"
  - "Modern CSS features"
...
<video controls autoPlay loop muted playsInline>
  <source src="/articles/transition-from-display-none.mp4" type="video/mp4" />
